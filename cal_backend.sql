...
-- Crear índices para mejorar performance (opcional)
...
WHERE schemaname = 'public' 
    AND tablename IN ('users', 'events', 'meetings', 'integrations', 'availability', 'day_availability')
ORDER BY tablename;